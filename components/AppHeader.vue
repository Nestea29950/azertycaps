  ...
  <header>
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-4 dark:bg-gray-800">
      ...
      >
        ...
        <NuxtLink  to="/contact" class="hover:underline lg:order-3 hidden lg:flex lg:items-center py-2 pr-4 pl-3 font-medium text-gray-800 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
