  ...
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
      <div>
        ...
        <h2 class="mt-3 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Keycaps Français</h2>
      </div>
      <div class="flex items-center space-x-4">
        <button data-modal-toggle="filterModal" @click="filterModal = true" data-modal-target="filterModal" type="button" class="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 sm:w-auto">
    ...
    <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
      <div v-for="clavier in props.ListClavier" :key="clavier.id" class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a :href="clavier.url">
            <img class="mx-auto h-full dark:hidden" :src="clavier.image_url" alt="" />
        ...
        <div class="pt-6">
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{{clavier.nom}}</a>
          ...
          <ul class="mt-2 flex items-center gap-4">
            <li class="flex items-center gap-2">
              ...
              <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{clavier.hauteur}}</p>
            </li>
            ...
            <li class="flex items-center gap-2">
              ...
              <p class="text-sm font-medium text-gray-500 dark:text-gray-400 ">{{clavier.materiaux}}</p>
            </li>
          </ul>

          <div class="mt-4 flex items-center justify-between gap-4">
            <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">{{clavier.prix}}</p>

            <button type="button" class="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white bg-slate-600 hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
