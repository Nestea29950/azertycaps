  ...
  <footer class="bg-white rounded-lg m-4 dark:bg-gray-800">
    ...
    >
      <span class="text-sm text-gray-700 sm:text-center dark:text-gray-400"
        >© 2025
        <a href="https://williamgaonarch.fr/" class="hover:underline">William™</a>.
        Tous droits réservés.
      </span>
      <ul
        class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-700 dark:text-gray-400 sm:mt-0 gap-4"
      >
      <li>
